...
def main():
    ...
    sorted_dictionary = sorted(english_spanish)
    sorted_dictionary_lenght = len(sorted_dictionary)

    for i in range(0, sorted_dictionary_lenght, 1):
        if i == (sorted_dictionary_lenght - 1):
            print(sorted_dictionary[i], sep="")
        else:
            print(sorted_dictionary[i], ", ", sep="", end="")
